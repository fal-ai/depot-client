...
from depotdev.api.depot.build.v1 import build_pb2
from depotdev.api.depot.buildkit.v1 import buildkit_pb2
from depotdev.api.depot.core.v1 import build_pb2 as core_build_pb2
from depotdev.client import Client, AsyncClient, BuildEndpoint
...
class TestSyncClient:
    ...
    def client(self):
        with patch('grpc.secure_channel') as mock_channel:
            ...
            mock_channel.assert_called_once_with('test.depot.dev:443', grpc.ssl_channel_credentials())
            yield client
...
class TestAsyncClient:
    ...
    async def test_create_build(self, client):
        ...
        client.build.CreateBuild = AsyncMock(return_value=build_pb2.CreateBuildResponse(
            build_id=expected_build_id,
            build_token=expected_token
        ))
